...
import com.yl.triplibrary.ui.widget.StickyHeaderListView.adapter.FilterLeftAdapter;
import com.yl.triplibrary.ui.widget.StickyHeaderListView.adapter.FilterOneAdapter;
import com.yl.triplibrary.ui.widget.StickyHeaderListView.adapter.FilterRightAdapter;
...
public class FilterView extends LinearLayout implements View.OnClickListener {
    ...
    private void initView(View view) {
        ...
        tvFilterTitle = (TextView)view.findViewById(R.id.tv_filter_title);
        ivFilterArrow = (ImageView)view.findViewById(R.id.iv_filter_arrow);
        viewMaskBg = (View)view.findViewById(R.id.view_mask_bg);

...
public class TipStratygyImgAdapter extends DelegateAdapter.Adapter<TipStratygyImgAdapter.RecyclerViewItemHolder> {
    ...
    public TipStratygyImgAdapter(Context mContext, LayoutHelper mHelper, List<ImgInfoEntity> mDatas) {
    ...
    public RecyclerViewItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext)
                .inflate(R.layout.item_trip_strategy_img_layout, parent, false);

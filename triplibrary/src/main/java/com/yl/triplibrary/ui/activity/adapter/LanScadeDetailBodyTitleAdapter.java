...
public class LanScadeDetailBodyTitleAdapter extends DelegateAdapter.Adapter<LanScadeDetailBodyTitleAdapter.RecyclerViewItemHolder> {
    ...
    public LanScadeDetailBodyTitleAdapter(Context mContext, LayoutHelper mHelper, String title) {
    ...
    public RecyclerViewItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext)
                .inflate(R.layout.item_lanscade_detail_title_layout, parent, false);

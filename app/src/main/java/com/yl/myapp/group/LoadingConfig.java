...
public class LoadingConfig {
    ...
    public static LoadEntity createEntity(Scene scene) {
        ...
        switch (scene) {
            case DEFAULT:
                ...
                emptyResource.setImage(R.mipmap.ic_load_empty);
    ...
    private static void paperChecks(LoadEntity loadEntity) {
        ...
        gsonLoadResource.setImage(R.mipmap.ic_load_empty);
        ...
        noNetworkResource.setImage(R.mipmap.ic_load_no_network);
        ...
        errorResource.setImage(R.mipmap.ic_load_empty);

...
object DataManager {
    val homeMenuList: List<MultiItemEntity>
        get() {
            ...
            menuBeanList.add(MenuBean(R.drawable.ic_tick_parent, NetConstant.MENU_P_CODE,NetConstant.LABEL_P_CODE, 1,"标签"))//表示有子集
            menuBeanList.add(MenuBean(R.drawable.ic_collection_box, NetConstant.MENU_P_CODE,NetConstant.LIST_P_CODE, 0,"收集箱"))

package com.yl.markremember.ui.fragment.list
...
class ListTaskListFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val emptyview=LayoutInflater.from(activity).inflate(R.layout.fragment_task_list_empty,null)
        adapter?.run {

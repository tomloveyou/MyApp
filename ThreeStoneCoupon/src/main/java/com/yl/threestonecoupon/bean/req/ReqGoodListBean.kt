...
class ReqGoodListBean(
         ...
         */
        val juHuaSuan: Int?=null,
        /**
         *1-淘抢购商品，0-所有商品，不填默认为0
         */
        val taoQiangGou: Int?=null,
        /**
         ...
         *1-天猫商品， 0-非天猫商品，不填默认所有商品
         */
        val tchaoshi: Int?=null,
        /**
         *1-金牌卖家商品，0-所有商品，不填默认为0
         */
        val goldSeller: Int?=null,
        /**
         ...
         *价格（券后价）下限
         */
        val priceLowerLimit: Int?=null,
        /**
         *价格（券后价）上限
         */
        val priceUpperLimit: Int?=null,
        /**
         *最低佣金比率
         */
        val commissionRateLowerLimit: Int?=null,
        /**
         *最低月销量
         */
        val monthSalesLowerLimit: Int?=null,
        /**
         *商品卖点，1.拍多件活动；2.多买多送；3.限量抢购；4.额外满减；6.买商品礼赠
         */
        val specialId: Int?=null,
        /**
         *偏远地区包邮，1-是，0-非偏远地区，不填默认所有商品
         */
        val freeshipRemoteDistrict: Int?=null,
        /**
         *最低优惠券面额
         */
        val couponPriceLowerLimit: Int?=null
)